...
- Para compilar y ejecutar el programa se debe ejecutar el siguiente comando en terminal:
  ...
  -> En la carpeta mazo se crean 108 cartas, y se reparten 28 de ellas a los 4 jugadores (7 a cada uno), y una a la carpeta ulyima Carta 
    por lo que la carpeta queda con 80 cartas. 
